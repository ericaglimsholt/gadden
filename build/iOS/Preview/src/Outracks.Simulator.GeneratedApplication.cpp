...
static void GeneratedApplication_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("192.168.0.16");
    ::STRINGS[2] = uString::Const("169.254.133.242");
